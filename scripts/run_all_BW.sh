#!/bin/bash
# Master script to run all BW (Best-Worst) experiments across environments and model types
...
echo "========================================"
echo "BW (Best-Worst) EXPERIMENTS BATCH"
...
echo ""
echo "========================================"
echo "ALL BW EXPERIMENTS COMPLETED"
